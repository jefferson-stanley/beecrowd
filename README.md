## a funcao recebe os vagões e a quantidade como parâmetros e usa um bubble sort para ordenar a lista e um contador para armazenar a quantidade de trocas 
